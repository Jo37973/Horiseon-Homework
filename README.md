## Horiseon Homework: Joanna Pastcan

# Description 
* As a Coding-Bootcamp student, I will apply my knowledge to this assignment. 

* My motivation is to optomize this website for search engines, provide a logical structure to the elements while providing accessible attributes, and end in a functioning website. This has been achieved by applying the skills I have learned thus far in Bootcamp. 

* I built this project to be able to apply my skills and optimize the site for search engines, for the marketing agency. 

* These revisions solve a few problems, including accessibility where there wasn't before in image tags. This revised code has more comprehensible flow that follows a logical structure and sequential order, and also includes notes for better understanding. 
...
* Coding-Bootcamp Horiseon Homework: © 2021 Trilogy Education Services, LLC, a 2U, Inc. brand. Confidential and Proprietary. All Rights Reserved.

# Horiseon Homework README:
## User Story
